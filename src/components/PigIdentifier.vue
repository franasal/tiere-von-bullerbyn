  ...
  data() {
    return {
      ...
      pigInfo: {
        ...
        Maike: {
          description: 'Weiblich, rosa, voll behaart, rechte Ohrmarke/Loch. Mangalitza-Wollschwein. Kümmerling aus Biobetrieb, wurde gerne abgegeben, war lange dominant in der Rotte bis Nia und Hedda kamen.',
